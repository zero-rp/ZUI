...
{
    js_pushnumber(J, len);
    js_setproperty(J, idx < 0 ? idx - 1 : idx, L"length");
}
...
static void Ap_every(js_State *J)
{
    ...
    if (!js_iscallable(J, 1))
        js_typeerror(J, L"callback is not a function");
...
void jsB_initarray(js_State *J)
{
    ...
    {
        jsB_propf(J, L"Array.prototype.toString", Ap_toString, 0);
        jsB_propf(J, L"Array.prototype.concat", Ap_concat, 0); /* 1 */
        jsB_propf(J, L"Array.prototype.join", Ap_join, 1);
        jsB_propf(J, L"Array.prototype.pop", Ap_pop, 0);
        jsB_propf(J, L"Array.prototype.push", Ap_push, 0); /* 1 */
        jsB_propf(J, L"Array.prototype.reverse", Ap_reverse, 0);
        jsB_propf(J, L"Array.prototype.shift", Ap_shift, 0);
        jsB_propf(J, L"Array.prototype.slice", Ap_slice, 2);
        jsB_propf(J, L"Array.prototype.sort", Ap_sort, 1);
        jsB_propf(J, L"Array.prototype.splice", Ap_splice, 0); /* 2 */
        jsB_propf(J, L"Array.prototype.unshift", Ap_unshift, 0); /* 1 */

        /* ES5 */
        jsB_propf(J, L"Array.prototype.indexOf", Ap_indexOf, 1);
        jsB_propf(J, L"Array.prototype.lastIndexOf", Ap_lastIndexOf, 1);
        jsB_propf(J, L"Array.prototype.every", Ap_every, 1);
        jsB_propf(J, L"Array.prototype.some", Ap_some, 1);
        jsB_propf(J, L"Array.prototype.forEach", Ap_forEach, 1);
        jsB_propf(J, L"Array.prototype.map", Ap_map, 1);
        jsB_propf(J, L"Array.prototype.filter", Ap_filter, 1);
        jsB_propf(J, L"Array.prototype.reduce", Ap_reduce, 1);
        jsB_propf(J, L"Array.prototype.reduceRight", Ap_reduceRight, 1);
    }
    js_newcconstructor(J, jsB_new_Array, jsB_new_Array, L"Array", 0); /* 1 */
    {
        /* ES5 */
        jsB_propf(J, L"Array.isArray", A_isArray, 1);
    }
    js_defglobal(J, L"Array", JS_DONTENUM);
}
