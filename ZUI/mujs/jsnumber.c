...
void jsB_initnumber(js_State *J)
{
	...
	{
		jsB_propf(J, L"Number.prototype.valueOf", Np_valueOf, 0);
		jsB_propf(J, L"Number.prototype.toString", Np_toString, 1);
		jsB_propf(J, L"Number.prototype.toLocaleString", Np_toString, 0);
		jsB_propf(J, L"Number.prototype.toFixed", Np_toFixed, 1);
		jsB_propf(J, L"Number.prototype.toExponential", Np_toExponential, 1);
		jsB_propf(J, L"Number.prototype.toPrecision", Np_toPrecision, 1);
	}
	js_newcconstructor(J, jsB_Number, jsB_new_Number, L"Number", 0); /* 1 */
	{
		jsB_propn(J, L"MAX_VALUE", 1.7976931348623157e+308);
		jsB_propn(J, L"MIN_VALUE", 5e-324);
		jsB_propn(J, L"NaN", NAN);
		jsB_propn(J, L"NEGATIVE_INFINITY", -INFINITY);
		jsB_propn(J, L"POSITIVE_INFINITY", INFINITY);
	}
	js_defglobal(J, L"Number", JS_DONTENUM);
}
