...
const wchar_t *js_itoa(wchar_t buf[32], int a);
...
const wchar_t *jsV_numbertostring(js_State *J, wchar_t buf[32], double number);
double jsV_stringtonumber(js_State *J, const wchar_t *string);
...
js_Property *jsV_nextproperty(js_State *J, js_Object *obj, const wchar_t *name);
