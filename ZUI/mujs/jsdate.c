...
static double parseDateTime(const wchar_t *s)
{
...
static void Dp_toJSON(js_State *J)
{
    ...
    js_getproperty(J, 0, L"toISOString");
    if (!js_iscallable(J, -1))
        js_typeerror(J, L"Date.prototype.toJSON: this.toISOString not a function");
    js_copy(J, 0);
    js_call(J, 0);
}
...
void jsB_initdate(js_State *J)
{
    ...
    {
        jsB_propf(J, L"Date.prototype.valueOf", Dp_valueOf, 0);
        jsB_propf(J, L"Date.prototype.toString", Dp_toString, 0);
        jsB_propf(J, L"Date.prototype.toDateString", Dp_toDateString, 0);
        jsB_propf(J, L"Date.prototype.toTimeString", Dp_toTimeString, 0);
        jsB_propf(J, L"Date.prototype.toLocaleString", Dp_toString, 0);
        jsB_propf(J, L"Date.prototype.toLocaleDateString", Dp_toDateString, 0);
        jsB_propf(J, L"Date.prototype.toLocaleTimeString", Dp_toTimeString, 0);
        jsB_propf(J, L"Date.prototype.toUTCString", Dp_toUTCString, 0);

        jsB_propf(J, L"Date.prototype.getTime", Dp_valueOf, 0);
        jsB_propf(J, L"Date.prototype.getFullYear", Dp_getFullYear, 0);
        jsB_propf(J, L"Date.prototype.getUTCFullYear", Dp_getUTCFullYear, 0);
        jsB_propf(J, L"Date.prototype.getMonth", Dp_getMonth, 0);
        jsB_propf(J, L"Date.prototype.getUTCMonth", Dp_getUTCMonth, 0);
        jsB_propf(J, L"Date.prototype.getDate", Dp_getDate, 0);
        jsB_propf(J, L"Date.prototype.getUTCDate", Dp_getUTCDate, 0);
        jsB_propf(J, L"Date.prototype.getDay", Dp_getDay, 0);
        jsB_propf(J, L"Date.prototype.getUTCDay", Dp_getUTCDay, 0);
        jsB_propf(J, L"Date.prototype.getHours", Dp_getHours, 0);
        jsB_propf(J, L"Date.prototype.getUTCHours", Dp_getUTCHours, 0);
        jsB_propf(J, L"Date.prototype.getMinutes", Dp_getMinutes, 0);
        jsB_propf(J, L"Date.prototype.getUTCMinutes", Dp_getUTCMinutes, 0);
        jsB_propf(J, L"Date.prototype.getSeconds", Dp_getSeconds, 0);
        jsB_propf(J, L"Date.prototype.getUTCSeconds", Dp_getUTCSeconds, 0);
        jsB_propf(J, L"Date.prototype.getMilliseconds", Dp_getMilliseconds, 0);
        jsB_propf(J, L"Date.prototype.getUTCMilliseconds", Dp_getUTCMilliseconds, 0);
        jsB_propf(J, L"Date.prototype.getTimezoneOffset", Dp_getTimezoneOffset, 0);

        jsB_propf(J, L"Date.prototype.setTime", Dp_setTime, 1);
        jsB_propf(J, L"Date.prototype.setMilliseconds", Dp_setMilliseconds, 1);
        jsB_propf(J, L"Date.prototype.setUTCMilliseconds", Dp_setUTCMilliseconds, 1);
        jsB_propf(J, L"Date.prototype.setSeconds", Dp_setSeconds, 2);
        jsB_propf(J, L"Date.prototype.setUTCSeconds", Dp_setUTCSeconds, 2);
        jsB_propf(J, L"Date.prototype.setMinutes", Dp_setMinutes, 3);
        jsB_propf(J, L"Date.prototype.setUTCMinutes", Dp_setUTCMinutes, 3);
        jsB_propf(J, L"Date.prototype.setHours", Dp_setHours, 4);
        jsB_propf(J, L"Date.prototype.setUTCHours", Dp_setUTCHours, 4);
        jsB_propf(J, L"Date.prototype.setDate", Dp_setDate, 1);
        jsB_propf(J, L"Date.prototype.setUTCDate", Dp_setUTCDate, 1);
        jsB_propf(J, L"Date.prototype.setMonth", Dp_setMonth, 2);
        jsB_propf(J, L"Date.prototype.setUTCMonth", Dp_setUTCMonth, 2);
        jsB_propf(J, L"Date.prototype.setFullYear", Dp_setFullYear, 3);
        jsB_propf(J, L"Date.prototype.setUTCFullYear", Dp_setUTCFullYear, 3);

        /* ES5 */
        jsB_propf(J, L"Date.prototype.toISOString", Dp_toISOString, 0);
        jsB_propf(J, L"Date.prototype.toJSON", Dp_toJSON, 1);
    }
    js_newcconstructor(J, jsB_Date, jsB_new_Date, L"Date", 0); /* 1 */
    {
        jsB_propf(J, L"Date.parse", D_parse, 1);
        jsB_propf(J, L"Date.UTC", D_UTC, 7);

        /* ES5 */
        jsB_propf(J, L"Date.now", D_now, 0);
    }
    js_defglobal(J, L"Date", JS_DONTENUM);
}
