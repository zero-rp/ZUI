...
exports.Udp = Udp;
function Udp() {
    this.handle = uv.new_udp.call(this);
}
Udp.prototype.__proto__ = Stream.prototype;
Udp.prototype.bind = function bind(host, port) {
    return uv.udp_bind(this.handle, host, port);
};
//REQ
exports.Req = Req;
function Req(req) {
