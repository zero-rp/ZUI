...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        void signature(const wchar_t* font_signature)
        {
			m_font_signature = (wchar_t*)m_allocator.allocate(wcslen(font_signature)*sizeof(wchar_t) + 2);
            wcscpy(m_font_signature, font_signature);
            memset(m_glyphs, 0, sizeof(m_glyphs));
        }

        //--------------------------------------------------------------------
        bool font_is(const wchar_t* font_signature) const
        {
            return wcscmp(font_signature, m_font_signature) == 0;
        }
    ...
    public:
        ...
        //--------------------------------------------------------------------
        void font(const wchar_t* font_signature, bool reset_cache = false)
        {
        ...
        //--------------------------------------------------------------------
        int find_font(const wchar_t* font_signature)
        {
            unsigned i;
            for(i = 0; i < m_num_fonts; i++)
            {
    ...
    public:
        ...
        //--------------------------------------------------------------------
        const glyph_cache* glyph(wchar_t glyph_code)
        {
            synchronize();
